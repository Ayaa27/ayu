...
public class MateriListView extends Activity implements OnClickListener,
OnItemClickListener, OnItemLongClickListener{
private java.util.ArrayList<String> items = new
java.util.ArrayList<String>();
private ListView mataKuliahListView;
private String[] listMataKuliah = {"Algorithma Pemrograman I","Algorithma Pemrograman II",
		"Struktur Data I","Struktur Data II","Mobile Programming","Pemrograman I",
		"Pemrograman II","Bahasa Indonesia","Agama","PKN","Bahasa Inggris","Basis Data I",
		"Basis Data II","Kalkulus","Aljabar Linier","Matematika Diskrit","Fisika","Etika Profesi"};
@Override
...
getMenuInflater().inflate(R.menu.activity_materi_list_view, menu);
return true;
}
